        ...
        <div class="full-center">
            <form class="shadow-lg card upload-book p-5" action="{{ route('store_book') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="md-form md-outline">
                    ...
                    <label for="form-lg">Titre</label>
                </div>
                <div class="file-upload-wrapper d-flex justify-content-center align-items-center text-center p-3 mt-1 mb-3" id="drop_zone" ondrop="dropHandler(event);" ondragover="dragOverHandler(event);">
                    <p>Choisir ou drag & drop la couverture</p>
                </div>

                <div class="file-upload-wrapper d-flex justify-content-center align-items-center text-center p-3 mt-1 mb-1" id="drop_zone_ipdf" ondrop="dropHandlerIpdf(event);" ondragover="dragOverHandlerIpdf(event);">
                  <p>Choisir ou drag & drop le pdf du livre</p>
                </div>
                <div id="list" class="d-flex flex-row justify-content-center align-items-center text-center">
                    <h5 id="ipdf_name"></h5>
                </div>
                <div class="md-form md-outline">
                    <input id="form-lg" class="form-control form-control-lg" type="number" name="prix">
                    <label for="form-lg">Prix</label>
                </div>
                <div class="md-form">
                ...
                <input type="file" id="input-file-now-custom-2" class="file-upload" style="display: none" name="pdf_url" accept=".pdf"/>
